...
\begin{itemize}
  ...
  \item \textbf{BET as budgeted coverage.} We cast evidence tokenization as a budgeted coverage objective and relate it to classical submodular maximization, motivating greedy approximations and auditable allocation proxies.
