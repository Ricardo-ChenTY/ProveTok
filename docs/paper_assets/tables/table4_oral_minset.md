...
| `C0004` | Pass | fixed_grid_pass=6/6(need4); roi_variance_pass=6/6(need4) | one-sided (H1>0) + Holm(budgets), n_boot=20000 | `/home/ubuntu/tiasha/ProveTok/outputs/E0156-grounding_proof_100g_saliency_full/figX_grounding_proof.json` |
