...
| `C0004` | Pass | proved: provetok_lesionness beats fixed_grid and roi_variance on iou_union (Holm) with >= 4 budgets each | `/home/ubuntu/tiasha/ProveTok/outputs/E0156-grounding_proof_100g_saliency_seed20/figX_grounding_proof.json` |
