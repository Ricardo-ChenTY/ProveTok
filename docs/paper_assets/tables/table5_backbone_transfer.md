...
| `llama2` | provetok_lesionness/fixed_grid | 0,1,2 | 30 | 20000 | 1/3 (sig 1/3, avg d=0.0280) | 1/3 (sig 0/3, avg d=0.0005) | 2/3 (sig 0/3, avg d=0.8667) | `outputs/E0172-backbone-llama2-mini/baselines_curve_multiseed.json` |
